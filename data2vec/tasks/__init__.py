...
from data2vec.tasks.image_pretraining import ImagePretrainingTask, ImagePretrainingConfig
...
from .mae_image_classification import MaeImageClassificationTask, MaeImageClassificationConfig
