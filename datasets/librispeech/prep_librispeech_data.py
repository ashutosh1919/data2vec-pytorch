...
# Uncomment below if you want to download all files.
SPLITS = [
    # "train-clean-100",
    "train-clean-360",
    # "train-other-500",
...
def process(args):
    ...
    for split in SPLITS:
        ...
        for wav, sample_rate, _, spk_id, chapter_no, utt_no in tqdm(dataset):
            ...
            extract_fbank_features(
                wav, sample_rate, feature_root / f"{sample_id}.flac"
            )
    ...
    audio_paths, audio_lengths = get_zip_manifest(zip_path, feature_root)
    # print(audio)
